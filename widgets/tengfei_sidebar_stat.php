<?php
    ...
    class EfanWebsitestat extends WP_Widget
    {
        ...
        function __construct()
        {
            ...
            parent::__construct(false, 'ZibTF 侧边栏统计', $widget_ops);
        ...
        {
            wp_enqueue_style('tengfei-author-widget-style', get_stylesheet_directory_uri() . '/widgets/css/tengfei_sidebar.css', array(), '1.0.0');
        }
