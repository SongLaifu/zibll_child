...
class ProgressClock {
  ...
  getMonthInfo(mo, yr) {
    switch (mo) {
      case 1:
        return { name: "2 月", days: yr % 4 === 0 ? 29 : 28 };
      case 2:
        return { name: "3 月", days: 31 };
      case 3:
        return { name: "4 月", days: 30 };
      case 4:
        return { name: "5 月", days: 31 };
      case 5:
        return { name: "6 月", days: 30 };
      case 6:
        return { name: "7 月", days: 31 };
      case 7:
        return { name: "8 月", days: 31 };
      case 8:
        return { name: "9 月", days: 30 };
      case 9:
        return { name: "10 月", days: 31 };
      case 10:
        return { name: "11 月", days: 30 };
      case 11:
        return { name: "12 月", days: 31 };
      default:
        return { name: "1 月", days: 31 };
    }
  }
  update() {
    this.time = new Date();
    if (this.el) {
      ...
      const units = [
        ...
        { label: "mo", value: monthInfo.name, progress: mo_progress },
        { label: "d", value: day, progress: d_progress },
        { label: "h", value: hr > 12 ? hr - 12 : hr, progress: h_progress },
        { label: "m", value: min < 10 ? "0" + min : min, progress: m_progress },
        { label: "s", value: sec < 10 ? "0" + sec : sec },
        { label: "ap", value: hr > 12 ? "PM" : "AM" },
      ];
